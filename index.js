...
function superbowlWin(records) {
    // Use find() to look for the first record where the result is 'W'
...
describe('superbowlWin(record)', function () {
  const record = [
    ...
    { year: "2015", result: "W" }, // Denver Broncos won in 2015
    ...
    { year: "1998", result: "W" }, // Another win in 1998
    { year: "1997", result: "W" }, // Another win in 1997
